...
class Batter:
    ...
    def get_player_stats(cls, element: Element, url: str, name: str) -> dict:
        ...
        return {
            ...
            'OPS': element.find('td:nth-child(19)', first=True).text,
            'TB': element.find('td:nth-child(20)', first=True).text,
            'GIDP': element.find('td:nth-child(21)', first=True).text,
            'HBP': element.find('td:nth-child(22)', first=True).text,
            'SH': element.find('td:nth-child(23)', first=True).text,
            'SF': element.find('td:nth-child(24)', first=True).text,
            'IBB': element.find('td:nth-child(25)', first=True).text,
        }
